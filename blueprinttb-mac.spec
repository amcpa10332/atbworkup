...
"""
PyInstaller spec for Blueprint Trial Balance -- macOS .app bundle.
...
Build with:
    pyinstaller blueprinttb-mac.spec --noconfirm

Output:
    dist/BlueprintTB.app   <- zip this for distribution (see build_mac.sh)
