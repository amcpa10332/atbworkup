...
"""
PyInstaller spec for Blueprint Trial Balance — Windows onedir build.

Build with:
    pyinstaller blueprinttb.spec --noconfirm

Output:
    dist/BlueprintTB/   <- the whole folder is the app; zip it for distribution
...
a = Analysis(
    ...
    # none of them are used by blueprinttb itself. Exclude them so an
...
exe = EXE(
    ...
    icon='blueprinttb/assets/app_icon.ico',
)
