...
DEFAULT_TAX_LINES: list[tuple] = [
    ...
    # ── Schedule M-1 special deductions (Lines 29a–29b) ─────────────────────
    # Each is its own section/bucket (not lumped into "Deductions") so it
    # gets its own "Total X" subtotal in the report views — the NOL
    # deduction has to be its own subtotal ahead of the DRD since the DRD is
    # computed on income after the NOL is absorbed.
    ("1120", "ProfitAndLoss", "Net Operating Loss Deduction", 30, "29a",   "Net Operating Loss Deduction",                10),
    ("1120", "ProfitAndLoss", "Dividends Received Deduction", 40, "29b",   "Dividends Received Deduction",                10),
