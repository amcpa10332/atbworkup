...
from blueprinttb.ui.new_workup_dialog import NewWorkupDialog
from blueprinttb.ui.workup_window import WorkupWindow


class StartScreen(QWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Blueprint Trial Balance")
    ...
    def _ensure_profile(self):
        try:
            from blueprinttb.db.settings import has_profile, save_profile
            if not has_profile():
                from blueprinttb.ui.first_launch_dialog import FirstLaunchDialog
    ...
    def _on_new(self):
        ...
        try:
            ...
            from blueprinttb.db.settings import get_active_profile, set_role_for_job
    ...
    def _on_open(self):
        path, _ = QFileDialog.getOpenFileName(
            ...
            "Blueprint Trial Balance Files (*.bta.xlsx *.atbr.xlsx);;All Files (*)",
        )
        if not path:
            return

        from blueprinttb.db.settings import (
        ...
        if role is None:
            from blueprinttb.ui.role_dialog import RoleDialog
    ...
    def _on_rollforward(self):
        from blueprinttb.ui.rollforward_dialog import RollforwardDialog
        ...
        try:
            ...
            from blueprinttb.exporter.review_package import save_workup
            from blueprinttb.db.settings import get_active_profile, set_role_for_job
            from blueprinttb.models.rollforward import create_rollforward
    ...
    def _on_new_consolidated(self):
        ...
        try:
            ...
            from blueprinttb.db.connection import db_connection
            from blueprinttb.exporter.review_package import save_workup
            from blueprinttb.db.settings import get_active_profile
            from blueprinttb.ui.consolidation_window import ConsolidationWindow
    ...
    def _on_manage_templates(self):
        from blueprinttb.ui.template_manager import TemplateManagerDialog
