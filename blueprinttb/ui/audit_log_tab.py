...
# Human-readable labels for common event types. Falls back to the raw
# event_type string (title-cased) for anything not listed here -- see
# _populate_table -- so a missing entry never hides a row, just shows a
# less friendly label.
_EVENT_LABELS = {
    "imported_tb":        "Import TB",
    "reimported_tb":      "Reimport TB",
    "added_aje":          "Add Journal Entry",
    "changed_aje":        "Change Journal Entry",
    "deleted_aje":        "Delete Journal Entry",
    "signoff_aje":        "Reviewer Sign Off",
    "removed_signoff":    "Remove Reviewer Sign Off",
    "mapped_account":     "Map Account",
    "changed_mapping":    "Change Mapping",
    "flag_changed":       "Flag Changed",
    "created_account":    "Create Account",
    "edited_account":     "Edit Account",
    "export_package":     "Export Package",
    "exported_package":   "Export Package",
    "opened_from_package":"Open From Package",
    "created_job":        "Create Job",
    "created_workup":     "Create Workup",
    "opened_workup":      "Open Workup",
    "updated_job":        "Update Job",
    "status_changed":     "Status Changed",
    "rollforward_created":"Roll Forward",
