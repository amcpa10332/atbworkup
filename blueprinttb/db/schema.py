"""
Full binder schema. Applied once on .btaw creation.
All monetary amounts use sign convention: DR = positive, CR = negative.
"""

from blueprinttb.constants import SCHEMA_VERSION, APP_VERSION  # noqa: F401 (re-exported)
...
SCHEMA_STATEMENTS = [
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS tax_grouping_ties (
