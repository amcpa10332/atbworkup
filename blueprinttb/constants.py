APP_VERSION = "2.0.0"
APP_NAME = "BlueprintTB"          # folder-name-safe identifier (%APPDATA%\BlueprintTB, %TEMP%\BlueprintTB)
APP_DISPLAY_NAME = "Blueprint Trial Balance"   # full product name for window titles / prose
SCHEMA_VERSION = "1.0"
...
def get_entity_types() -> list[tuple[str, str]]:
    ...
    """
    try:
        from blueprinttb.db.settings import list_templates
